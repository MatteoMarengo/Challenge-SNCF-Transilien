...
#########################################################"
X_train_IDS_ARRAY_job_1 = X_train_IDS_ARRAY[X_train_IDS_ARRAY[:, 2] == 1]
X_train_IDS_ARRAY_job_0 = X_train_IDS_ARRAY[X_train_IDS_ARRAY[:, 2] == 0]

# Associate the y to the new X_train
Y_train_IDS_ARRAY_job_1 = Y_IDS_ARRAY[X_train_IDS_ARRAY[:, 2] == 1]
Y_train_IDS_ARRAY_job_0 = Y_IDS_ARRAY[X_train_IDS_ARRAY[:, 2] == 0]
